...
public class XmlUnmarshaller {
    ...
    public static NachrichtStrafOwiVerfahrensmitteilungExternAnJustiz0500010 unmarshalNachrichtStrafOwiVerfahrensmitteilungExternAnJustiz0500010(String xml) throws Exception {
