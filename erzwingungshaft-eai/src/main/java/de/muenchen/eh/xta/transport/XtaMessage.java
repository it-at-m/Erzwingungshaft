package de.muenchen.eh.xta.transport;
...
import de.muenchen.eh.xta.transport.container.RequestGenericContentContainerBuilder;
import de.muenchen.eh.xta.transport.metadata.PartyBuilder;
import de.muenchen.eh.xta.transport.metadata.PartyIdentifierBuilder;
import de.muenchen.eh.xta.transport.metadata.RequestMessageMetaDataBuilder;
...
public class XtaMessage {
    ...
    public Exchange send(Exchange exchange) {
        ...
        ClaimProcessingContentWrapper contentWrapper = exchange.getMessage().getBody(ClaimProcessingContentWrapper.class);
