...
public class XtaClientConfig {
     ...
     */
    @NotEmpty private String managementPortUri;

    /**
     * URI des Send-Services.
     */
    @NotEmpty private String sendPortUri;

    /**
     * URI des Message-Box-Services.
     */
    @NotEmpty private String msgBoxportUri;

    /**
     * Keystore für die Client-Authentifizierung.
     * Enthält privaten Schlüssel und Zertifikatskette, die der Server vertraut.
     */
    @Valid private final KeyStore clientCertKeystore = null;
     ...
     */
    @Valid private final KeyStore trustStore = null;
     ...
     */
    @NotEmpty private XtaBusinessScenario businessScenario;

    /**
     * Set MessageType!
     */
    @NotEmpty private XtaMessageType messageType;

    /**
     * Anzahl der Metadaten-Elemente pro Abruf.
     */
    @Positive private final int maxListItems = 50;

    /**
     * Ob das XTA-SOAP-Schema validiert wird.
     */
    @Valid private final boolean schemaValidation = true;
