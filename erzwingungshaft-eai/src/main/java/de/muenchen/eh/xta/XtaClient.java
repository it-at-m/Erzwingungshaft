...
public class XtaClient {
     ...
     * clientIdentifiers =
     * clientIdentifiers.stream().filter(xtaClientService::isAccountActive).toList();
     *
     * List<XtaFetchMessageMetaData> mappedClientIdentifiers =
     * clientIdentifiers.stream().map(clientIdentifier -> new XtaFetchMessageMetaData(clientIdentifier,
     * processMessage, Collections.emptySet())).toList();
     *
     * // fetch messages for each clientIdentifier
     * List<XtaStatusListing> xtaStatusListings =
     * clientIdentifiers.stream().map(xtaClientService::getStatusList).toList();
     *
     ...
     * //
     * XtaFetchMessageMetaData xtaFetchMessageMetaData = new XtaFetchMessageMetaData(clientIdentifier,
     ...
     * }
     *
     * public void fetchMessagesFrom(XtaIdentifier clientIdentifier, Consumer<XtaMessage>
     * processMessage) {
     * checkIfAccountIsActive(clientIdentifier);
     *
     * XtaFetchMessageMetaData param = new XtaFetchMessageMetaData(clientIdentifier, processMessage,
