...
class DevelopmentReadCreateFilingTest {
    ...
    void test_5_claims() throws Exception {
        ...
        assertEquals(26, claimLogRepository.count(), "24 claim logs expected.");
        assertEquals(23, claimLogRepository.findByMessageTyp(MessageType.INFO).size(), "21 import INFO expected.");
